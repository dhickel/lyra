...
- [`decisions.md`](decisions.md): durable accepted language, architecture, product, and workflow tradeoffs with rationale and review conditions.
- [`deferred-features.md`](deferred-features.md): accepted capabilities intentionally excluded from the current normative language scope.
- [`horizon-ideas.md`](horizon-ideas.md): unaccepted possible future direction.
