...
/** An immutable positional Lyra function type. */
public final class FunctionType implements LyraType {
    ...
    public FunctionType(List<? extends LyraType> parameterTypes, LyraType returnType) {
        ...
        String parameters = this.parameterTypes.stream().map(LyraType::canonicalSpelling)
                .reduce((left, right) -> left + "," + right).orElse("");
        this.canonical = "Fn<" + parameters + ";" + returnType.canonicalSpelling() + ">";
    }

    public static FunctionType of(List<? extends LyraType> parameterTypes, LyraType returnType) {
    ...
    public boolean equals(Object other) {
        return this == other || other instanceof FunctionType function
