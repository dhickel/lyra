...
public final class TupleType implements LyraType {
    ...
    public TupleType(List<? extends LyraType> memberTypes) {
        ...
        if (memberTypes.isEmpty()) {
            throw new IllegalArgumentException("Tuple[] is Unit; an empty tuple type is not a distinct type");
        }
    ...
    public boolean equals(Object other) {
        return this == other
                || other instanceof TupleType tuple && memberTypes.equals(tuple.memberTypes);
    }
