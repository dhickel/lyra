...
cd -- "$LYRA_FUZZ_ROOT"
exec mvn -pl lyra-compiler -am test -Dtest=LanguageFuzzTest,RangeIntegrationTest,CallbackLoopIntegrationTest,NominalSyntaxTest,NominalSemanticsTest,NominalTypeTest,NominalTypeContractTest,NominalArtifactMetadataTest,NominalConstructionTest,GeneratedTypePlannerTest \
